...
inside Pyodide in the browser; tests/js/pyodide.test.ts checks the two agree.
...
sys.path.insert(0, os.path.join(HERE, '..', '..', 'src', 'execution', 'python'))
...
class Speed(unittest.TestCase):
    def test_five_thousand_steps_natively(self):
        ...
        # Native CPython; Pyodide is measured against the real budget in tests/js.
